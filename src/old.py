...
def load_mat2(file: str, linkLag: str, valLag: str):
    """
...
def make_directed_graph(file):
    ...
    for lag in vallag_list:
        lag_dicts.append(load_mat2(file, lag[0], lag[1]))
...
def make_graph_lag0(file: str):
    ...
    '''
    G:Graph= Graph()
    linkl= load_mat2(file, 'linkLag0', 'vallag0')
    ...
    for node in linkl:
        ...
        for xnode in linkl[node]:
            ...
            G.add_edge(node, xnode, color= '#1fffff')
    return G
